...
export function Skills() {
  return (
    (<div>
      <CardSkeletonContainer className='flex flex-col mt-[50px] justify-start items-center'>
      <h3 className="text-2xl -mb-[50px] md:-mb-[30px] font-bold text-white">Skills</h3>
        <Skeleton />
...
export const CardSkeletonContainer = ({
  ...
  return (
    (<div
      className={cn("h-[15rem] md:h-[13rem] rounded-xl z-40", className, showGradient &&
        "bg-neutral-300 dark:bg-[rgba(0,0,0,0.7)] [mask-image:radial-gradient(50%_50%_at_50%_50%,white_0%,transparent_100%)]")}>
      {children}
    </div>)
  );
};
